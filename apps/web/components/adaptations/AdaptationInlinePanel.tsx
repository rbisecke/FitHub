 ...
 * Merge/Reject mirror the same verdict vocabulary as the dedicated review
 * page's Merge/Adjust/Reject buttons (they're the same underlying decision,
 * just a two-button shortcut); "Review in full" deep-links to the dedicated
 * page for the Adjust path and per-session review — this panel never offers
 * Adjust or per-session staging itself. An 8.6-Full surface: it presumes the
 * same whole-adaptation verdict wiring as the dedicated page (merge now
 * really rewrites sessions), so "Merge" is a real merge, not a
