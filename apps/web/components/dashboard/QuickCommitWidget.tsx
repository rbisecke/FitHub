...
export function QuickCommitWidget() {
  return (
    <div className="bg-[var(--card)] border border-[rgba(74,222,128,0.3)] rounded-2xl p-5">
      ...
      <Link
        href="/log/new"
        className="flex items-center justify-center gap-2 bg-[var(--accent)] text-[var(--bg)] font-bold text-[13px] py-2.5 rounded-[10px] hover:brightness-110 transition-all"
      >
