  ...
  return (
    <div className="flex flex-col gap-4 py-8 px-2">
      <div>
        ...
        <p className="font-mono text-xs text-[#30363d] mt-1">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
        {STARTER_PROMPTS.map((prompt) => (
          <button
            ...
            className="rounded-md border border-[#30363d] bg-[#161b22] px-3 py-2.5 text-left font-mono text-xs text-[#8b949e] hover:border-[#58a6ff] hover:text-[#e6edf3] transition-colors duration-100"
          >
            &ldquo;{prompt}&rdquo;
          </button>
        ))}
