...
| `feat/ui-onboarding` | ✅ Done | #64 | 5-step wizard (/onboarding/1-5), onboarding_completed migration 0036, parse-nl route, dashboard toast. ui-iterate: ghost button touch targets min-h-[44px], desktop vertical centering (md:flex md:items-center on layout), Step1 body paragraph merged, Step4 textarea aria-label. |
